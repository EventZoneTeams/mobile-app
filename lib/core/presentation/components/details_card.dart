...
class DetailsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // context
    //     .read<WatchlistBloc>()
    //     .add(CheckItemAddedEvent(id: eventDetail.id));
    return SafeArea(
      child: Stack(
        children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '${eventDetail.totalCost} ',
                                style: textTheme.bodyMedium,
                              ),
                              Text(
                                eventDetail.donationStartDate,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                //           eventDetails.isAdded = false;
                //         } else if (state.status ==
                //                 WatchlistRequestStatus.isItemAdded &&
                //             state.id != -1) {
                //           eventDetails.id = state.id;
                //           eventDetails.isAdded = true;
                //         }
                //       },
                //       builder: (context, state) {
                //         return Icon(
                //           Icons.bookmark_rounded,
                //           color: eventDetails.isAdded
                //               ? AppColors.primary
